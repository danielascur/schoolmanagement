// Purpose: PISA figures
	
*------------------------------------------------------
* GRAPHs of PISA MGMT INDICES QUARTILES X PISA SCORE
*------------------------------------------------------
...
foreach c of local lcty {
	...
	cap drop gmi_`c'
	cap xtile qgmi_`c' = zmgmt_wms_practices if cnt == "`c'", nq(4)
...
graph bar _math _reading _science, over(qgmi)  /// 
	...
	graph export "analysis/results/figure_1.pdf", as(pdf) replace  
